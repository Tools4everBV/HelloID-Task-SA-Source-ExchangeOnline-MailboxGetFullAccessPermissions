...
try {
    ...
    try {
        ...
        $mailboxPermissions = Get-EXOMailboxPermission @exchangeQuerySplatParams | Where-Object { ($_.accessRights -like "*fullaccess*") -and -not($_.Deny -eq $true) } -ErrorAction Stop
